...
?>
	...
	<div id="footer" class="col-full">
        ...
        <?php if( wootique_get_woo_option( 'woo_footer_right' ) == 'true' ) {
			...
			<p><a href="<?php echo ( wootique_get_woo_option( 'woo_footer_aff_link' ) ? esc_url( wootique_get_woo_option( 'woo_footer_aff_link' ) ) : 'http://www.woothemes.com' ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/logotype.png" width="180" height="40" alt="Woo Themes" /></a></p>
		<?php } ?>
		</div>
