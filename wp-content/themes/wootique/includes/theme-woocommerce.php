...
function wootique_header_search() {
	...
	<div id="search-top">
    	...
    	<form role="search" method="get" id="searchform" class="searchform" action="<?php echo home_url(); ?>">
			<label class="screen-reader-text" for="s"><?php _e('Wyniki dla:', 'woothemes'); ?></label>
			<input type="text" value="<?php the_search_query(); ?>" name="s" id="s"  class="field s" placeholder="<?php _e('Szukaj przedmiotów', 'woothemes'); ?>" />
